...
window.TASKFLOW_DATA = {
  ...
  tasks: [
    // ---- Austin ----
    { id: "s-aus11", projectId: "proj-austin", title: "DD questions — GS, both directions", summary: "Ours waits on Laura; theirs needs circulating", group: "Diligence", due: "2026-08-12", priority: "high", assignee: "Me", status: "To Do",
    ...
    { id: "s-aus7", projectId: "proj-austin", title: "Structure chart — finalise Austin", summary: "Handover item, due before lender diligence", group: "Structuring", due: "2026-08-11", priority: "medium", assignee: "Me", status: "To Do",
      notes: "Per Laura's handover, ahead of lender diligence.", source: "backlog" },
    { id: "s-aus15", projectId: "proj-austin", title: "Structure chart — finalise Austin 1", summary: "Drafted, but may be too detailed for the teaser", group: "Structuring", due: "2026-08-11", priority: "medium", assignee: "Me", status: "To Do",
      notes: "Drafted; flagged to Laura it may be too much detail for teaser stage — finalize for lender diligence.", source: "backlog" },
    { id: "s-aus14", projectId: "proj-austin", title: "DD responses — clear Randy's, send to T&T & GS", summary: "Randy answered 7/30 — check off and forward", group: "Diligence", due: "2026-08-12", priority: "high", assignee: "Me", status: "To Do",
    ...
    { id: "t-aus25", projectId: "proj-austin", title: "Model — ask Goldman for theirs", summary: "Sits with the other open GS diligence items", group: "Diligence", due: "", priority: "medium", assignee: "Me", status: "To Do",
    ...
    { id: "t-aus26", projectId: "proj-austin", title: "Teaser — GS version, last page cut", summary: "Goldman only; everyone else keeps the full deck", group: "Lender materials", due: "", priority: "medium", assignee: "Me", status: "To Do",
    ...
    { id: "t-aus24", projectId: "proj-austin", title: "LTA report — review Austin v2", summary: "T&T issued v2 on 8/6; expect a comment round", group: "Diligence", due: "", priority: "medium", assignee: "Me", status: "To Do",
    ...
    { id: "t-aus23", projectId: "proj-austin", title: "Lender email — updated AUS10 draft", summary: "Which email wasn't specified — confirm first", group: "Lender materials", due: "", priority: "medium", assignee: "Me", status: "To Do",
    ...
    { id: "t-aus20", projectId: "proj-austin", title: "Wastewater & roads — prep the call", summary: "MUD route open; tax-exempt bonds look unavailable", group: "Power & permitting", due: "2026-08-11", priority: "high", assignee: "Me", status: "To Do",
    ...
    { id: "t-aus21", projectId: "proj-austin", title: "PUCT — track the 8/14 and 8/20 hearings", summary: "Audit process expected at both", group: "Power & permitting", due: "2026-08-14", priority: "medium", assignee: "Me", status: "To Do",
    ...
    // ---- Ashville 1 ----
    { id: "s-ash13", projectId: "proj-ashville", title: "OM — comment pass", summary: "Went to Davis Polk; Elli Park confirmed receipt", group: "OM & launch", due: "2026-08-11", priority: "high", assignee: "Me", status: "To Do",
    ...
    { id: "s-ash14", projectId: "proj-ashville", title: "DPW diligence — chase responders", summary: "O&M request drafted; confirm before it goes", group: "Diligence", due: "2026-08-12", priority: "high", assignee: "Me", status: "To Do",
    ...
    { id: "t-ash20", projectId: "proj-ashville", title: "Financials — Non-GAAP and parent entity", summary: "Resolved in-thread by Laura and Amy", group: "Diligence", due: "2026-08-11", priority: "high", assignee: "Me", status: "To Do",
    ...
    { id: "t-ash21", projectId: "proj-ashville", title: "Executed contracts — send to Davis Polk", summary: "Alexis flagged them for you; DPW needs them", group: "Diligence", due: "2026-08-11", priority: "high", assignee: "Me", status: "To Do",
    ...
    { id: "s-ash15", projectId: "proj-ashville", title: "LTA report — chase signed construction contracts", summary: "The last open item on the report", group: "Diligence", due: "", priority: "medium", assignee: "T&T", status: "To Do",
    ...
    { id: "t-ash23", projectId: "proj-ashville", title: "Power contracts — check with Shelly", summary: "PowerConneX side; feeds the PPA owed to DPW", group: "Power", due: "", priority: "medium", assignee: "Me", status: "To Do",
    ...
    { id: "t-ash24", projectId: "proj-ashville", title: "Ground lease — energy centre acreage", summary: "Blocked until BCEI gives the legal description", group: "Diligence", due: "", priority: "medium", assignee: "Me", status: "To Do",
    ...
    { id: "s-ash12", projectId: "proj-ashville", title: "Referendum — reply to Ares", summary: "A reply is still owed", group: "Scheduling & admin", due: "", priority: "medium", assignee: "Me", status: "To Do",
      notes: "Reply still owed to Ares on the referendum question.", source: "backlog" },
    { id: "s-ash7", projectId: "proj-ashville", title: "Rating agency — confirm slots with Macy", summary: "Technical advisor sessions in the same ask", group: "Scheduling & admin", due: "2026-08-11", priority: "medium", assignee: "Me", status: "To Do",
    ...
    { id: "s-ash2", projectId: "proj-ashville", title: "Newmark — revoke access, send RFS dates", summary: "Two parts, one thread", group: "Scheduling & admin", due: "2026-08-11", priority: "medium", assignee: "Me", status: "To Do",
    ...
    { id: "s-ash10", projectId: "proj-ashville", title: "Launch — Ashville 1", summary: "OM now with DPW; no new date stated", group: "OM & launch", due: "", priority: "high", assignee: "Me", status: "To Do",
    ...
    { id: "t-ash22", projectId: "proj-ashville", title: "Board slides — MOR financing update", summary: "Rithika needs it for the CFO update", group: "Reporting", due: "2026-08-11", priority: "high", assignee: "Me", status: "To Do",
    ...
    // ---- Ashville 2 ----
    { id: "t-ash2-1", projectId: "proj-ashville2", title: "Amort & sizing — re-cut the profile", summary: "Sculpted, bullet after 5\u20137; sizing follows", group: "Lease terms", due: "", priority: "high", assignee: "Me", status: "To Do",
    ...
    { id: "t-ash2-2", projectId: "proj-ashville2", title: "Lease — tighten assignment and CoC", summary: "HY ignores these; asset-level lenders will not", group: "Lease terms", due: "", priority: "medium", assignee: "Me", status: "To Do",
    ...
    { id: "t-ash2-3", projectId: "proj-ashville2", title: "Lease — DP to circle with leasing team", summary: "Nothing moves until they revert", group: "Lease terms", due: "", priority: "medium", assignee: "Davis Polk", status: "To Do",
    ...
    // ---- Scioto ----
    { id: "t-sci1", projectId: "proj-scioto", title: "Financing options — prep Thursday's call", summary: "Thu 12:00 MT confirmed; two stale holds", group: "Financing options", due: "2026-08-13", priority: "medium", assignee: "Me", status: "To Do",
    ...
    // ---- Canyon ----
    { id: "t-can1", projectId: "proj-canyon", title: "Credit agreement — review the K&S draft", summary: "Landed 8/9, clean and marked", group: "Documentation", due: "2026-08-13", priority: "medium", assignee: "Me", status: "To Do",
    ...
    // ---- Enigma ----
    { id: "s-eni3", projectId: "proj-enigma", title: "Scenario & consents — engage counsel", summary: "Waits on EQT's model", group: "Structuring", due: "2026-08-14", priority: "medium", assignee: "Me", status: "To Do",
    ...
    // ---- Leroy (post-closing) ----
    { id: "t-ler10", projectId: "proj-leroy", title: "Upsize — get time with Clay", summary: "Booked for Wed 2:30 PM MT", group: "Upsize", due: "2026-08-12", priority: "medium", assignee: "Me", status: "To Do",
    ...
    { id: "s-ler1", projectId: "proj-leroy", title: "Reliance letters — Finland", summary: "Post-closing from the 7/31 funding", group: "Post-closing", due: "", priority: "medium", assignee: "Me", status: "To Do",
      notes: "Post-closing item following the 7/31 Finland closing/funding (Bx wired).", source: "backlog" },
    { id: "s-ler2", projectId: "proj-leroy", title: "Reliance letters — Norway", summary: "Same pattern as Finland", group: "Post-closing", due: "", priority: "medium", assignee: "Me", status: "To Do",
      notes: "Same post-closing requirement as Finland.", source: "backlog" },
    { id: "s-ler3", projectId: "proj-leroy", title: "Exhibit A — Finland, post-closing", summary: "Valuation could move at the next draw", group: "Post-closing", due: "", priority: "medium", assignee: "Me", status: "To Do",
    ...
    { id: "s-ler4", projectId: "proj-leroy", title: "Punch list — request the Austin update", summary: "NMRK and T&T engaged; about two weeks", group: "Austin campus punch list", due: "2026-08-11", priority: "medium", assignee: "Me", status: "To Do",
      notes: "NMRK and T&T already engaged. ~2 weeks for the punch list; Bx to come back with questions after.", source: "backlog" },
    { id: "s-ler5", projectId: "proj-leroy", title: "Punch list — pull Austin diligence", summary: "Our side while NMRK and T&T review", group: "Austin campus punch list", due: "", priority: "medium", assignee: "Me", status: "To Do",
      notes: "Our side of the punch-list process while NMRK/T&T run their review.", source: "backlog" },
    { id: "s-ler6", projectId: "proj-leroy", title: "Punch list — Rithika to consolidate", summary: "Working through the open items", group: "Austin campus punch list", due: "", priority: "medium", assignee: "Rithika", status: "In Progress",
    ...
    { id: "t-stab1", projectId: "proj-stab", title: "Model — build the stabilization case", summary: "Laura's longer-term ask", group: "Model & options", due: "", priority: "medium", assignee: "Me", status: "To Do",
    ...
    { id: "t-stab2", projectId: "proj-stab", title: "Financing options — stabilized assets", summary: "Follows once the model has a first cut", group: "Model & options", due: "", priority: "medium", assignee: "Me", status: "To Do",
    ...
    // ---- Internal ----
    { id: "t-int1", projectId: "proj-internal", title: "Eelco — 30\u201360 min to order his to-dos", summary: "A working session, not a status update", group: "Team", due: "", priority: "medium", assignee: "Me", status: "To Do",
    ...
    // ---- AI Projects ----
    { id: "s-ai4", projectId: "proj-ai", title: "Bank tracker — reach out to Pradeep", summary: "To kick the build off", group: "Dashboards", due: "", priority: "medium", assignee: "Me", status: "To Do",
      notes: "Kick off the bank relationship tracker build.", source: "backlog" },
    { id: "s-ai1", projectId: "proj-ai", title: "Bank tracker — build it", summary: "First cut live as the bank dashboard", group: "Dashboards", due: "", priority: "medium", assignee: "Me", status: "In Progress",
    ...
    { id: "s-ai2", projectId: "proj-ai", title: "Comps dashboard — build it", summary: "Pricing, structure, tenor and sponsor by deal", group: "Dashboards", due: "", priority: "medium", assignee: "Me", status: "To Do",
      notes: "Live dashboard of data-center financing comps — pricing, structure, tenor, sponsor across recent deals.", source: "backlog" },
    { id: "t-ai5", projectId: "proj-ai", title: "DD database — questions and answers", summary: "A seed sheet already exists in SharePoint", group: "Due diligence", due: "", priority: "high", assignee: "Me", status: "To Do",
    ...
    { id: "t-ai6", projectId: "proj-ai", title: "DD database — ask corp dev what they have", summary: "They already use AI on equity DD", group: "Due diligence", due: "", priority: "high", assignee: "Me", status: "To Do",
    ...
    { id: "s-ai3", projectId: "proj-ai", title: "Legal agent — first-pass documents", summary: "Same corpus as the DD database", group: "Due diligence", due: "", priority: "medium", assignee: "Me", status: "To Do",
