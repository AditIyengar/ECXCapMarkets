...
window.TASKFLOW_DATA = {
  ...
  tasks: [
    // ---- Austin ----
    { id: "s-aus11", projectId: "proj-austin", title: "Work both sides of the GS DD questions", summary: "Ours waits on Laura; theirs needs circulating", group: "Diligence", due: "2026-08-12", priority: "high", assignee: "Me", status: "To Do",
    ...
    { id: "s-aus7", projectId: "proj-austin", title: "Finalize Austin structure chart", summary: "Handover item, needed before lender diligence", group: "Structuring", due: "2026-08-11", priority: "medium", assignee: "Me", status: "To Do",
      notes: "Per Laura's handover, ahead of lender diligence.", source: "backlog" },
    { id: "s-aus15", projectId: "proj-austin", title: "Finalize Austin 1 structure chart", summary: "Drafted, but may be too detailed for the teaser", group: "Structuring", due: "2026-08-11", priority: "medium", assignee: "Me", status: "To Do",
      notes: "Drafted; flagged to Laura it may be too much detail for teaser stage — finalize for lender diligence.", source: "backlog" },
    { id: "s-aus14", projectId: "proj-austin", title: "Review Randy's DD responses; check off and send to T&T & GS", summary: "Randy answered 7/30 — check off and forward", group: "Diligence", due: "2026-08-12", priority: "high", assignee: "Me", status: "To Do",
    ...
    { id: "t-aus25", projectId: "proj-austin", title: "Ask Goldman for their models", summary: "Sits with the other open GS diligence items", group: "Diligence", due: "", priority: "medium", assignee: "Me", status: "To Do",
    ...
    { id: "t-aus26", projectId: "proj-austin", title: "Send Goldman a teaser with the last page removed", summary: "Goldman only; everyone else keeps the full deck", group: "Lender materials", due: "", priority: "medium", assignee: "Me", status: "To Do",
    ...
    { id: "t-aus24", projectId: "proj-austin", title: "Review the Austin v2 LTA report", summary: "T&T issued v2 on 8/6 — expect a comment round", group: "Diligence", due: "", priority: "medium", assignee: "Me", status: "To Do",
    ...
    { id: "t-aus23", projectId: "proj-austin", title: "Updated AUS10 draft email", summary: "Which email wasn't specified — confirm first", group: "Lender materials", due: "", priority: "medium", assignee: "Me", status: "To Do",
    ...
    { id: "t-aus20", projectId: "proj-austin", title: "Prep for Austin wastewater / road financing call (Tue 1:00 PM MT)", summary: "MUD route open; tax-exempt bonds look unavailable", group: "Power & permitting", due: "2026-08-11", priority: "high", assignee: "Me", status: "To Do",
    ...
    { id: "t-aus21", projectId: "proj-austin", title: "Track PUCT public meetings on the governor's directive (8/14 and 8/20)", summary: "PUCT meets 8/14 and 8/20 on the audit process", group: "Power & permitting", due: "2026-08-14", priority: "medium", assignee: "Me", status: "To Do",
    ...
    // ---- Ashville 1 ----
    { id: "s-ash13", projectId: "proj-ashville", title: "Go through the Ashville 1 OM and leave comments", summary: "Overdue on Davis Polk's clock since their 8/5 chase", group: "OM & launch", due: "2026-08-11", priority: "high", assignee: "Me", status: "To Do",
    ...
    { id: "s-ash14", projectId: "proj-ashville", title: "Chase responders on the DPW diligence request", summary: "O&M request drafted; confirm it before it goes", group: "Diligence", due: "2026-08-12", priority: "high", assignee: "Me", status: "To Do",
    ...
    { id: "t-ash20", projectId: "proj-ashville", title: "Reply to Amy Shockley — Non-GAAP language + who the parent is", summary: "Her answer gates the senior indebtedness figure", group: "Diligence", due: "2026-08-11", priority: "high", assignee: "Me", status: "To Do",
    ...
    { id: "t-ash21", projectId: "proj-ashville", title: "Send the executed Ashville contracts to Davis Polk", summary: "Alexis flagged them for you; DPW still needs them", group: "Diligence", due: "2026-08-11", priority: "high", assignee: "Me", status: "To Do",
    ...
    { id: "s-ash15", projectId: "proj-ashville", title: "Follow up on signed construction contracts for the LTA report", summary: "Last open item on the LTA report", group: "Diligence", due: "", priority: "medium", assignee: "T&T", status: "To Do",
    ...
    { id: "t-ash23", projectId: "proj-ashville", title: "Check with Shelly on the Ashville 1 power contracts", summary: "PowerConneX side; feeds the PPA still owed to DPW", group: "Power", due: "", priority: "medium", assignee: "Me", status: "To Do",
    ...
    { id: "t-ash24", projectId: "proj-ashville", title: "Track the energy centre ground lease for the bond acreage", summary: "Blocked until BCEI gives the legal description", group: "Diligence", due: "", priority: "medium", assignee: "Me", status: "To Do",
    ...
    { id: "s-ash12", projectId: "proj-ashville", title: "Respond to Ares on the Ashville referendum", summary: "Reply still owed on the referendum question", group: "Scheduling & admin", due: "", priority: "medium", assignee: "Me", status: "To Do",
      notes: "Reply still owed to Ares on the referendum question.", source: "backlog" },
    { id: "s-ash7", projectId: "proj-ashville", title: "Reply to Macy — technical advisor & rating agency meetings", summary: "Confirm slots for the TA and rating agency sessions", group: "Scheduling & admin", due: "2026-08-11", priority: "medium", assignee: "Me", status: "To Do",
    ...
    { id: "s-ash2", projectId: "proj-ashville", title: "Revoke Newmark folder access & send updated RFS dates", summary: "Two parts: revoke access, then send the RFS dates", group: "Scheduling & admin", due: "2026-08-11", priority: "medium", assignee: "Me", status: "To Do",
    ...
    { id: "s-ash10", projectId: "proj-ashville", title: "Launch Ashville 1", summary: "OM now with DPW; no new launch date stated", group: "OM & launch", due: "", priority: "high", assignee: "Me", status: "To Do",
    ...
    { id: "t-ash22", projectId: "proj-ashville", title: "Update the MOR financing board slides", summary: "Rithika needs it by 8/11 for the CFO update", group: "Reporting", due: "2026-08-11", priority: "high", assignee: "Me", status: "To Do",
    ...
    // ---- Ashville 2 ----
    { id: "t-ash2-1", projectId: "proj-ashville2", title: "Re-cut the Ashville 2 amortisation profile and debt sizing", summary: "Sculpted amort, bullet after 5\u20137; sizing follows", group: "Lease terms", due: "", priority: "high", assignee: "Me", status: "To Do",
    ...
    { id: "t-ash2-2", projectId: "proj-ashville2", title: "Tighten assignment provisions and change of control in the lease", summary: "HY ignores these; asset-level lenders will not", group: "Lease terms", due: "", priority: "medium", assignee: "Me", status: "To Do",
      notes: "Both are transfer and control provisions that high-yield investors typically do not fuss over but asset-level lenders do \u2014 which is exactly what an unwrapped Ashville 2 deal is. Kept as one review: same lease sections, same lender concern, and they will be negotiated together. CoC read as change of control.", source: "call notes 2026-08-11 \u2014 Ashville 2 lease changes" },
    { id: "t-ash2-3", projectId: "proj-ashville2", title: "Davis Polk to circle with the leasing team on the changes", summary: "Waiting on DP before anything gets redrafted", group: "Lease terms", due: "", priority: "medium", assignee: "Davis Polk", status: "To Do",
      notes: "Davis Polk will take the agreed lease changes to the leasing team. Nothing to do until they revert, but it gates the redraft \u2014 worth a nudge if it is quiet by the end of the week. 'DP' read as Davis Polk, who are already ECX counsel across the Ashville lease and OM threads.", source: "call notes 2026-08-11 \u2014 Ashville 2 lease changes" },

    // ---- Scioto ----
    { id: "t-sci1", projectId: "proj-scioto", title: "Prep for the Scioto financing options call", summary: "Thu 12:00 MT confirmed; two stale holds remain", group: "Financing options", due: "2026-08-13", priority: "medium", assignee: "Me", status: "To Do",
    ...
    // ---- Canyon ----
    { id: "t-can1", projectId: "proj-canyon", title: "Review the Project Canyon credit agreement draft", summary: "K&S draft landed 8/9, clean and marked", group: "Documentation", due: "2026-08-13", priority: "medium", assignee: "Me", status: "To Do",
    ...
    // ---- Enigma ----
    { id: "s-eni3", projectId: "proj-enigma", title: "Engage counsel on scenario & consent analysis", summary: "Waits on EQT's model before counsel goes on", group: "Structuring", due: "2026-08-14", priority: "medium", assignee: "Me", status: "To Do",
    ...
    // ---- Leroy (post-closing) ----
    { id: "t-ler10", projectId: "proj-leroy", title: "Get time with Clay (Blackstone) on the Leroy upsize / Austin addition", summary: "Clay offered time; a slot still needs booking", group: "Upsize", due: "2026-08-12", priority: "medium", assignee: "Me", status: "To Do",
    ...
    { id: "s-ler1", projectId: "proj-leroy", title: "Finland: reliance letters — environmental report & geotech", summary: "Post-closing item from the 7/31 Finland funding", group: "Post-closing", due: "", priority: "medium", assignee: "Me", status: "To Do",
      notes: "Post-closing item following the 7/31 Finland closing/funding (Bx wired).", source: "backlog" },
    { id: "s-ler2", projectId: "proj-leroy", title: "Norway: reliance letters — environmental report & geotech", summary: "Same post-closing pattern as Finland", group: "Post-closing", due: "", priority: "medium", assignee: "Me", status: "To Do",
      notes: "Same post-closing requirement as Finland.", source: "backlog" },
    { id: "s-ler3", projectId: "proj-leroy", title: "Finland: send updated Exhibit A to Bx (post-closing)", summary: "Valuation could move at the next draw", group: "Post-closing", due: "", priority: "medium", assignee: "Me", status: "To Do",
    ...
    { id: "s-ler4", projectId: "proj-leroy", title: "Send request for updated Austin campus punch list", summary: "NMRK and T&T engaged; about two weeks expected", group: "Austin campus punch list", due: "2026-08-11", priority: "medium", assignee: "Me", status: "To Do",
      notes: "NMRK and T&T already engaged. ~2 weeks for the punch list; Bx to come back with questions after.", source: "backlog" },
    { id: "s-ler5", projectId: "proj-leroy", title: "Austin campus: pull together diligence for the punch list", summary: "Our side while NMRK and T&T run their review", group: "Austin campus punch list", due: "", priority: "medium", assignee: "Me", status: "To Do",
      notes: "Our side of the punch-list process while NMRK/T&T run their review.", source: "backlog" },
    { id: "s-ler6", projectId: "proj-leroy", title: "Austin campus: Rithika to work through open items and revert", summary: "Rithika consolidating the open items", group: "Austin campus punch list", due: "", priority: "medium", assignee: "Rithika", status: "In Progress",
    ...
    { id: "t-stab1", projectId: "proj-stab", title: "Build the stabilization model (and options)", summary: "Laura's longer-term ask, not competing with this week", group: "Model & options", due: "", priority: "medium", assignee: "Me", status: "To Do",
    ...
    { id: "t-stab2", projectId: "proj-stab", title: "Work up stabilized financing options", summary: "Follows once the model has a first cut", group: "Model & options", due: "", priority: "medium", assignee: "Me", status: "To Do",
    ...
    // ---- Internal ----
    { id: "t-int1", projectId: "proj-internal", title: "Set up 30\u201360 min with Eelco to organise his to-dos", summary: "A working session, not a status update", group: "Team", due: "", priority: "medium", assignee: "Me", status: "To Do",
    ...
    // ---- AI Projects ----
    { id: "s-ai4", projectId: "proj-ai", title: "Reach out to Pradeep — bank relationship tracker", summary: "Kick the tracker build off with Pradeep", group: "Dashboards", due: "", priority: "medium", assignee: "Me", status: "To Do",
      notes: "Kick off the bank relationship tracker build.", source: "backlog" },
    { id: "s-ai1", projectId: "proj-ai", title: "Bank relationship tracker", summary: "First cut already live as the bank dashboard", group: "Dashboards", due: "", priority: "medium", assignee: "Me", status: "In Progress",
    ...
    { id: "s-ai2", projectId: "proj-ai", title: "Comps dashboard", summary: "Pricing, structure, tenor and sponsor by deal", group: "Dashboards", due: "", priority: "medium", assignee: "Me", status: "To Do",
      notes: "Live dashboard of data-center financing comps — pricing, structure, tenor, sponsor across recent deals.", source: "backlog" },
    { id: "t-ai5", projectId: "proj-ai", title: "DD question & answer database — stop answering the same question twice", summary: "A seed sheet already exists in SharePoint", group: "Due diligence", due: "", priority: "high", assignee: "Me", status: "To Do",
    ...
    { id: "t-ai6", projectId: "proj-ai", title: "Ask corp dev (Scott / Aaron / Alex) about their DD answer database", summary: "They already use AI on equity DD — ask before building", group: "Due diligence", due: "", priority: "high", assignee: "Me", status: "To Do",
    ...
    { id: "s-ai3", projectId: "proj-ai", title: "Legal agent", summary: "First-pass legal review, same corpus as DD", group: "Due diligence", due: "", priority: "medium", assignee: "Me", status: "To Do",
